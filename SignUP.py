...
class LoginSystem:
    def __init__(self, root):
        ...
        self.tc_check = IntVar()
        terms_conditions = Checkbutton(login_frame, text='I agree to the terms and conditions.', onvalue=1, offvalue=0,
                                       variable=self.tc_check, bg='white', font=('', 10))
        terms_conditions.place(x=50, y=400)
    ...
    def last_name_validation(self):
        if len(self.last_name_entry.get()) < 3:
            return True
        elif (
        ...
        if self.first_name_entry.get() == '':
            ...
            try:
                ...
                if row is not None:
                    ...
                    cur.execute(
                        'INSERT INTO SignUp VALUES (%s, %s, %s, %s, %s, %s, %s);',
